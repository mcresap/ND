...
setenv LD_LIBRARY_PATH "/afs/nd.edu/user14/csesoft/new/lib:/afs/nd.edu/user14/csesoft/new/lib64:$LD_LIBRARY_PATH"
setenv PATH /afs/nd.edu/user15/pbui/pub/anaconda3/bin:$PATH
if ($?prompt) then
