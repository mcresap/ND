...
void tree(int x1, int y1, int len, float ang)
{
  ...
  // gfx_line(x1, y1, x1+x1*cos(2*pi/5), y1+y1*sin(2*pi/5));
   ...
   tree(x1+len*cos(ang)*.25, y1+len*sin(ang)*.25, len/3, ang+pi/6);
   tree(x1+len*cos(ang)*.25, y1+len*sin(ang)*.25, len/3, ang-pi/6);
   tree(x1+len*cos(ang)*.5, y1+len*sin(ang)*.5, len/3, ang-pi/6 );
   tree(x1+len*cos(ang)*.5, y1+len*sin(ang)*.5, len/3, ang+pi/6);
   tree(x1+len*cos(ang)*.75, y1+len*sin(ang)*.75, len/3, ang+pi/6);
   tree(x1+len*cos(ang)*.75, y1+len*sin(ang)*.75, len/3, ang-pi/6);
   tree(x1+len*cos(ang), y1+len*sin(ang), len/3, ang+pi/6);
   tree(x1+len*cos(ang), y1+len*sin(ang), len/3, ang-pi/6);
   //tree(x1, y1, );
   //tree(x1, y1, );
}
